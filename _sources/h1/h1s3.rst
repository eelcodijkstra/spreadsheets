...
Met een formule in een cel kun je de waarde van die cel laten uitrekenen uit de waarden van andere cellen:
...
In je eigen kopie van dit voorbeeld kun je zien de formules in de verschillende cellen bekijken:
...
*Relatieve verwijzingen.* In veel gevallen wil je bij het kopiëren van een formule, eventueel met de vulgreep,
